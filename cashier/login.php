...
<head>
    ...
    <title>Welcome to Counter Manager</title>
...
<body class="bg-dark bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Welcome to Counter Manager</h3>
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                <form action="" id="login-form">
                    <center><small>Please Select Counter to Operate.</small></center>
                    <div class="form-group">
                        <label for="cashier_id" class="control-label">Counter</label>
                        <select name="cashier_id" id="cashier_id" data-placeholder="Please Select Counter to Operate" class="custom-select2 select2">
